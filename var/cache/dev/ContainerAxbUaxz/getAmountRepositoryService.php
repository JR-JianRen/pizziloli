 ...
 */
class getAmountRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AmountRepository' shared autowired service.
     *
     * @return \App\Repository\AmountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AmountRepository.php';

        return $container->privates['App\\Repository\\AmountRepository'] = new \App\Repository\AmountRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
