...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'picture', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'products'];
        }
     ...
     * {@inheritDoc}
     */
    public function setPicture(?string $picture): \App\Entity\Category
    {
