...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 16 mrt 2023 om 14:30
...
INSERT INTO `order` (`id`, `name`, `address`, `order_status`, `total_price`, `date`, `time`) VALUES
(1, 'ertert', 'ertert', 1, NULL, NULL, NULL),
(2, 'ertertdf', 'ertert', 1, NULL, NULL, NULL),
(3, 'ertert65y', 'tru5435', NULL, NULL, NULL, NULL);
